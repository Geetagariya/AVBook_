...
<section class="py-5" id="engineering">
    ...
    <div class="position-relative reveal">
        <button class="scroll-btn scroll-left" data-target="engineeringRow"><i class="fas fa-chevron-left"></i></button>
        <div class="channel-row" id="engineeringRow" data-autoscroll="true">
            <div class="channel-card" data-category="engineering" data-aos="fade-up">
...
$sql = "SELECT * FROM videos WHERE category='engineering'";
...
?>
    ...
    <div class="channel-card">
        <img class="thumb" src="<?php echo $row['thumbnail']; ?>">
        <h3><?php echo $row['title']; ?></h3>
        <p><?php echo $row['description']; ?></p>
        <p class="subscribers">Subscribers: <?php echo $row['subscribers']; ?></p>
        <a href="<?php echo $row['link']; ?>" target="_blank" class="btn btn-outline-primary">
            Visit Channel →
        </a>
        <button class="scroll-btn scroll-right" data-target="engineeringRow"><i class="fas fa-chevron-right"></i></button>
    </div>

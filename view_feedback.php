...
<head>
    ...
    <style>
        ...
        /* Popup Styles - Same as Contact Page */
        #deletePopup {
            display: none;
            position: fixed;
            top: 0;
...
<div id="deletePopup">
    <div id="popupContent">
        ...
        <p class="popup-message">Are you sure you want to delete this feedback? This action cannot be undone.</p>
...
function openPopup(id) {
    ...
    document.getElementById("confirmDelete").href = "delete_feedback.php?id=" + id;

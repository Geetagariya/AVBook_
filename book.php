...
$current_branch = isset($_GET['branch']) ? $_GET['branch'] : 'it_books';
  ...
  <div class="branch-nav-container">
    <div class="container">
      <div class="branch-nav-wrapper">
        <button class="branch-btn active" onclick="showBranch(event,'it_books')">
...
<button class="branch-btn" onclick="showBranch(event,'mech')">
 <i class="fas fa-cogs"></i>Mechanical</button>

<button class="branch-btn" onclick="showBranch(event,'elec')">
...
<button class="branch-btn" onclick="showBranch(event,'pharmacy')">
  ...
  <div class="search-container" id="searchContainer">
    ...
    <div class="search-box">
      <input type="text" id="bookSearch" placeholder="🔍 Search books by name..." onkeyup="searchBooks()">
...
<div class="books-section">
  ...
  <div id="it_books" class="book-section <?php echo $current_branch=='it_books' ? 'active' : ''; ?>">
  <div class="book-grid">
  ...
  while($row = mysqli_fetch_assoc($result)): 
    if(strtolower($row['branch'])=='it_books'):
      $count++;
  ?>
	...
	<div class="book-card">
          <div class="book-image-container">
			...
			<img src="images/books/<?php echo !empty($row['image']) ? $row['image'] : 'default.jpg'; ?>">
          </div>
          <div class="book-content">
            <h3><?php echo $row['title']; ?></h3>
            <a href="PDF/book_pdf/it_books/<?php echo $row['file']; ?>" class="download-btn" download>
  ...
  <!-- Mechanical Branch -->
  <div id="mech" class="book-section <?php echo $current_branch=='mech' ? 'active' : ''; ?>">
    <div class="book-grid">
      <?php 
      mysqli_data_seek($result, 0);
      $mech_count = 0;
      while($row = mysqli_fetch_assoc($result)): 
        if(strtolower($row['branch'])=='mech'):
          $mech_count++;
      ?>
        <div class="book-card">
          <div class="book-image-container">
          ...
          <div class="book-content">
            <h3><?php echo $row['title']; ?></h3>
            <a href="PDF/book_pdf/mech/<?php echo $row['file']; ?>" class="download-btn" download>
              <i class="fas fa-download"></i> Download
            </a>
          </div>
        </div>
  ...
  <!-- Electrical Branch -->
  <div id="elec" class="book-section <?php echo $current_branch=='electrical' ? 'active' : ''; ?>">
    <div class="book-grid">
      <?php 
      mysqli_data_seek($result, 0);
      $electrical_count = 0;
      ...
      ?>
        <div class="book-card">
          ...
          <div class="book-content">
            <h3><?php echo $row['title']; ?></h3>
            <a href="PDF/book_pdf/elec/<?php echo $row['file']; ?>" class="download-btn" download>
              <i class="fas fa-download"></i> Download
            </a>
          </div>
        </div>
...
// ⭐ PAGE LOAD DEFAULT IT
document.addEventListener("DOMContentLoaded", function(){
    updateBooksCount("it_books");
});

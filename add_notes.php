...
if(isset($_POST['upload'])){
    ...
    if(move_uploaded_file($temp, $pdf_path)){
        ...
        // ===== INSERT QUERY =====
        $query = "INSERT INTO notes (title, branch, semester, type, file_name, file_path)
                  VALUES ('$title','$branch','$semester','$type','$file','$pdf_path')";
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        body{
            ...
            /* ✅ SAME WHITE BACKGROUND AS BOOKS PAGE */
            background: #f8fafc;
            min-height:100vh;
            padding:20px;
        }
            ...
            <form method="POST" enctype="multipart/form-data" id="notesForm">
                ...
                <div class="form-group">
                    <label class="file-upload" for="pdfFile">
                        ...
                        <div>
                            <div class="file-info">📄 PDF File (Required)</div>

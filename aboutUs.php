    ...
    <header class="header-area">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <nav class="main-nav"> 
				<a href="index.php"><i class="fas fa-home"></i> Home</a> <a href="aboutUs.php"
                        class="active"><i class="fas fa-info-circle"></i> About</a> <a href="book.php"><i
                            class="fas fa-book"></i> Books</a> <a href="notes.php"><i class="fas fa-sticky-note"></i>
                        Notes</a> <a href="videos.php"><i class="fas fa-video"></i> Videos</a> <a href="audios.php"><i
                            class="fas fa-headphones"></i> Audios</a> <a href="brochure.php"><i
                            class="fas fa-users"></i> Brochure</a> <a href="contact.php"><i
                            class="fas fa-envelope"></i> Contact</a> <a href="announcement.php" class="new-btn"><i
        ...
        <div class="container">
            ...
            <div class="objectives-grid"> <!-- Objective 1 -->
                ...
                <div class="objective-card reveal">
                    ...
                    <p>To make learning more interactive through multi-format contentâ€”text, audio, and visuals.</p>
                </div> <!-- Objective 6 -->
                <div class="objective-card reveal">

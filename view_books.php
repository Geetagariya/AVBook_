...
<body>
    ...
    <div id="successModal" class="modal">
        <div class="modal-content">
            ...
            <h3>âœ… Book Deleted Successfully!</h3>
            <p>Library updated!</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <!-- âœ… SEARCH BAR ADDED BACK -->
        <div class="controls">
            <div class="search-box">
                <i class="fas fa-search"></i>
                <input type="text" id="searchInput" placeholder="ðŸ” Search by title, author or branch..." onkeyup="searchTable()">
            </div>
        </div>
    ...
    <div id="confirmBox">
        <div class="confirm-content">
            ...
            <button class="delete-btn" onclick="deleteBook()">ðŸ—‘ï¸ Yes, Delete Forever</button>
            <button class="cancel-btn" onclick="closeBox()">âŒ Cancel</button>
        </div>
    </div>
